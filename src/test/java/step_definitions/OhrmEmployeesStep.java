...
public class OhrmEmployeesStep extends ConfigurationReader{
    ...
    public static final Logger oLog = LogManager.getLogger(OhrmEmployeesStep.class);

    @Given("I'm on logged in to OrangeHRM as admin")
    public void i_m_on_logged_in_to_OrangeHRM_as_admin() {
        //Go to URL   driver.get(""):
